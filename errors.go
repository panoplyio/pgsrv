...
// InvalidCursorName indicates that a referred portal name is
// unknown/missing to the server.
func InvalidCursorName(name string) Err {
	msg := fmt.Sprintf("portal \"%s\" does not exist", name)
	return &err{M: msg, C: "34000", P: -1}
}
